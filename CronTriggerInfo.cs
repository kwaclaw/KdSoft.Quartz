...
namespace KdSoft.Quartz.AspNet
{
    ...
    public class CronTriggerInfo
    {
        ...
        /// <see cref="AspNet.MisfireInstruction"/> constants that may be set to this property.<br/>
        /// If not explicitly set, the default value is <see cref="AspNet.MisfireInstruction.InstructionNotSet"/>.</summary>
        /// <seealso cref="AspNet.MisfireInstruction"/>
